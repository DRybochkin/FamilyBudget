    ...
    static func initLineChartCell(cell: NamedLineChartTableViewCell!, chart: DOChart!) {
        if (cell != nil) {
            ...
            if (chart.data.count > 0) {
                ...
                xAxis.axisMinimum = xAxis.axisMinimum - 0.1/12.0
                xAxis.axisMaximum = xAxis.axisMaximum + 0.1/12.0
                yAxis.axisMaximum = yAxis.axisMaximum * 1.1
