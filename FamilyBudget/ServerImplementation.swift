...
class ServerImplementation: NSObject, ServerProtocol {
    ...
    func connectToServer(user: DOUser, callback: UserResponseCallback?) {
        let params = [ "deviceuid": SQLiteDataStore.deviceUID, "password": user.userPassword, "groupkeyword": user.userGroupKeyword, "title": user.userTitle, "accesstoken": _accessTokenWebApi, "usertick": SQLiteDataStore.sharedInstance.options.lastTick, "pushtoken": SQLiteDataStore.sharedInstance.options.notificationToken ] as [String : Any]
