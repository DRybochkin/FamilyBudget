...
protocol StatisticPageViewControllerDelegate: NSObjectProtocol {
...
class StatisticTableViewController: BaseTableViewController, StatisticPageViewControllerDelegate {
    ...
    convenience init(_ sections: [Section], _ pageControleler: StatisticPageViewController) {
        self.init(coder: NSCoder())
        self.sections = sections
        self.pageViewController = pageControleler
    }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            if (sections[indexPath.section].data.isEmpty) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if (statistic != nil && pageViewController != nil && !statistic.isEmpty) {
            if (statistic.dataTypes == [StatisticDataTypes.transaction]) {
                ...
                if let sc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "StatisticPageViewController") as? StatisticPageViewController {
